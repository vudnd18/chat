...
const startedDialog_1 = require("./dialogs/startedDialog");
...
const startedDialog = new startedDialog_1.StartedDialog(STARTED_DIALOG);
const dialog = new mainDialog_1.MainDialog(startedDialog);
