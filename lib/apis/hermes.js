...
exports.getFacilitiesByHotelId = exports.getInfo = void 0;
...
exports.getFacilitiesByHotelId = fbPageId => {
    return axios_1.default.get(`${url}/facilities-bot?fbPageId=${fbPageId}`);
};
