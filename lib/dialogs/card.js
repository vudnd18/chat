...
function bookingCard(name) {
    return botbuilder_1.CardFactory.heroCard("", `Để xem giá ƯU ĐÃI dành riêng cho ${name}, bạn vui lòng nhấn nút TÌM PHÒNG 👇 bên dưới nhé.`, botbuilder_1.CardFactory.images([""]), botbuilder_1.CardFactory.actions([
        {
            type: botbuilder_1.ActionTypes.OpenUrl,
            title: "TÌM PHÒNG",
